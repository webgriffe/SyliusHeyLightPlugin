...
final class HeylightFinancingGatewayFactory extends GatewayFactory
{
    protected function populateConfig(PayumArrayObject $config): void
    {
        $config->defaults([
            'payum.factory_name' => HeylightApi::HEYLIGHT_FINANCING_GATEWAY_CODE,
            'payum.factory_title' => 'HeyLight Financing',
