@paying_for_order
Feature: Paying with Heylight during checkout
    In order to buy products
    As a Customer
    I want to be able to pay with Heylight Payment Checkout
    ...
    Scenario: Successful payment
        ...
        And I proceeded with "Free" shipping method and "Heylight" payment
