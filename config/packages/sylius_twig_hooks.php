...
return static function (ContainerConfigurator $container): void {
    ...
    $container->extension('sylius_twig_hooks', [
        'hooks' => [
            'sylius_admin.payment_method.create.content.form.sections.gateway_configuration.heylight_bnpl' => $configFields,
            'sylius_admin.payment_method.update.content.form.sections.gateway_configuration.heylight_bnpl' => $configFields,
            'sylius_admin.payment_method.create.content.form.sections.gateway_configuration.heylight_financing' => $configFields,
            'sylius_admin.payment_method.update.content.form.sections.gateway_configuration.heylight_financing' => $configFields,
